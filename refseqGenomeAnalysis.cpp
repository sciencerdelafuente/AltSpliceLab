...
//============================== DISPLAY RESULTS   ============================ //
 ...
 //fout.precision(dbl::max_digits10);
  ...
  ofstream out("Output_Genome_Variables.txt", ios::app);
  out.precision(dbl::max_digits10);
  
  
  //out <<"FileName"<<"\t"<<"GenomeSize"<<"\t"<<"GeneSize"<<"\t"<<"Coding"<<"\t"<<"ASR"<<endl;
  out << argv[1]<<"\t"<<GenomeSize<<"\t"<<GeneSize<<"\t"<<Coding<<"\t"<<AlternativeSplicingRatio<<endl;
